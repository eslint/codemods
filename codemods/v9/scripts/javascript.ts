...
async function transform(root: SgRoot<JS>): Promise<string> {
  ...
  const requireJsdocRule = rootNode.findAll({
    rule: {
      kind: "pair",
      has: {
        kind: 'string',
  ...
  let noConstructorReturnRule = rootNode.find({
    rule: {
      kind: "pair",
      has: {
        kind: 'string',
  ...
  let noSequencesRule = rootNode.find({
    rule: {
      kind: "pair",
      has: {
        kind: 'string',
  ...
  let noUnusedVarsRule = rootNode.find({
    rule: {
      kind: "pair",
      has: {
        kind: 'string',
  ...
  let noUselessComputedVarsRule = rootNode.find({
    rule: {
      kind: "pair",
      has: {
        kind: 'string',
  ...
  let camelcaseRule = rootNode.find({
    rule: {
      kind: "pair",
      has: {
        any: [

...
export function removeEnvVarAssignments(source: string): string {
  let result = source
...
export function removeFlagValues(source: string): string {
  let result = source
...
export function removeEmptyFlagsAssignment(source: string): string {
...
export function removeCliFlags(source: string): string {
  let result = source
...
export function applyAllTransforms(source: string): string {
  let result = source
